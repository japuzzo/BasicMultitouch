...
public class TouchDisplayView extends View {
    ...
    // JTA 7/6/2014 Mods to sample source by Joseph Apuzzo
    // This is where I modded the sizes of the circles from
    // IRCLE_RADIUS_DP = 75f down to 30
    // CIRCLE_HISTORICAL_RADIUS_DP = 7f up to 10f

    private static final float CIRCLE_RADIUS_DP = 30f;
    // radius of historical circle in dp
    private static final float CIRCLE_HISTORICAL_RADIUS_DP = 10f;
